...
def user_data():
    if current_user.is_authenticated:
        return render_template('templates/user_data.html', user=current_user)
    else:
...
def login():
    ...
    return render_template('templates/login_enter.html', form=form)
...
def user_reg():
    ...
    if form3.validate_on_submit():
        ...
        return redirect(url_for('home.index'))
    return render_template('templates/user_reg.html', form2=form3)
